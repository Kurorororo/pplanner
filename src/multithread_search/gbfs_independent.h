#ifndef GBFS_INDEPENDENT_H_
#define GBFS_INDEPENDENT_H_
...
class GBFSIndependent : public Search {
 public:
  GBFSIndependent(std::shared_ptr<const SASPlus> problem,
 ...
 private:
  ...
  std::shared_ptr<SearchNode> GenerateSeeds();
  ...
  std::vector<std::shared_ptr<
      OpenList<std::vector<int>, std::shared_ptr<SearchNode> > > >
      open_lists_;
  std::mutex stat_mtx_;
};
