...
void MCSIndependent::InitHeuristics(int i,
...
void MCSIndependent::Init(const boost::property_tree::ptree &pt) {
  goal_.store(nullptr);
...
void MCSIndependent::Expand(int i) {
...
void MCSIndependent::DumpStatistics() const {
