#ifndef LOCK_FREE_CLOSED_LIST_FP_H_
#define LOCK_FREE_CLOSED_LIST_FP_H_
...
class LockFreeClosedListFP {
 public:
  LockFreeClosedListFP(int exponent = 26)
...
#endif  // LOCK_FREE_CLOSED_LIST_FP_H_
