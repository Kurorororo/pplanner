#ifndef PDDSBGBFS_LMC_H_
#define PDDSBGBFS_LMC_H_
...
class PDDSBGBFSLmc {
 ...
 private:
  ...
  void BytesToNode(int h, const unsigned char *d);
  ...
  bool BytesDD(int *info, int *node, const uint32_t *state);
