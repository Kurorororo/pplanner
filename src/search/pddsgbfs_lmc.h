#ifndef PDDSGBFS_LMC_H_
#define PDDSGBFS_LMC_H_
...
class PDDSGBFSLmc {
 public:
  PDDSGBFSLmc(const Domain &domain)
 ...
 private:
  ...
  bool BytesDD(const unsigned char *d, int *node, uint32_t *state);
