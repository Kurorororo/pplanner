...
class HDSWAstar {
 public:
  HDSWAstar(int weight, const Domain &domain)
 ...
 private:
  ...
  void NodeToBytes(int to_rank, int a, int parent, int step, const uint32_t *packed);
