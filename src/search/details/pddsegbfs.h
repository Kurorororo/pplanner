...
template<class H>
vector<int> PDDSEGBFS<H>::operator()() {
...
template<class H>
void PDDSEGBFS<H>::SendTermination() {
...
template<class H>
bool PDDSEGBFS<H>::ReceiveTermination() {
  int has_received = 0;
...
template<class H>
void PDDSEGBFS<H>::BytesToNode(const unsigned char *d) {
  int info[4];
  // info[0] = h
  // info[1] = operator
  // info[2] = parent
...
template<class H>
void PDDSEGBFS<H>::BytesToNode(int h, const unsigned char *d) {
  int info[3];
  // info[0] = operator
  // info[1] = parent
  // info[2] = parent rank
...
template<class H>
void PDDSEGBFS<H>::NodeToBytes(int to_rank, int a, int parent,
...
template<class H>
bool PDDSEGBFS<H>::BytesDD(int *info, const uint32_t *state) {
...
template<class H>
vector<int> PDDSEGBFS<H>::ExtractPath(int node) {
  int sum_expanded = 0;
  int sum_evaluated = 0;
  int sum_generated = 0;
  int sum_deadend = 0;
